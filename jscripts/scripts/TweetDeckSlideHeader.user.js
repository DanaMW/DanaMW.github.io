...
body.mouse-out div[class*="js-drawer.drawer"] {
...
body.mouse-in div[class*="js-drawer.drawer"] {
border: none !important;
border-radius: 0 !important;
position: fixed;
left: 0;
...
body:not(.mouse-in) div[class*="js-drawer.drawer"] {
...
// js-app-header pin-all app-header (open)
// application js-app is-condensed (closed)

function main() {
    var noBtn = $('#btn-slide').length == 0;
    if (noBtn) {
        $('div[class*="column-header"]').each(function() {
            $('<button>', {
                id: 'btn-slide',
                class: 'btn-slide',
            ...
            }).insertAfter('div[class*="column-header"]');
            $('<style>')
                .prop('type', 'text/css')
                .html(injCSS)
                .append('head');
...
$(document).on('click', '#btn-slide', (function() {
    $('body').toggleClass('nouse-out');
    if ($('body.reveal').length > 0) {
        $(document).on('mousemove', function(event) {
            if ($('body.mouse-out').length > 0 && event.pageX < 40) {
                $('body').toggleClass('mouse-in').toggleClass('mouse-out');
            }
            if ($('body.mouse-in').length > 0 && event.pageX > 320) {
                $('body').toggleClass('mouse-in').toggleClass('mouse-out');
            }
        })
    } else {
